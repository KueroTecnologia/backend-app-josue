...
namespace KED\Module\Checkout\Services\Cart;
...
use function KED\get_base_url_scheme_less;
use KED\Module\Checkout\Services\PriceHelper;
use KED\Services\Routing\Router;
use function KED\str_replace_last;
